...
subtitle: "Selected engagements — anonymized — across financial services, manufacturing, AdTech, retail and FMCG. Each card shows a live chart of the problem it solved."
toc: false
---
...
const PC = (() => {
  ...
  const PROJECTS = [
    ...
    { tag: 'Manufacturing · Advanced analytics (BCG)', title: "Efficiency optimization for one of the world's largest brewers", type: 'throughput', cap: 'throughput optimization', blurb: 'Brought ML and advanced analytics into an operational optimization engagement — turning messy production data into measurable efficiency gains. Yes, I once optimized a brewery.' },
    { tag: 'AdTech · ML &amp; experimentation', title: 'Real-time bidding systems for leading AdTech', type: 'auction', cap: 'open auction · 2nd-price', blurb: 'ML models that buy mobile display inventory in real time, paired with disciplined A/B testing and reinforcement learning — solutions that move profit, measurably.' },
    { tag: 'Retail · Causal inference', title: 'Marketing measurement &amp; optimization for a top global retailer', type: 'channels', cap: 'channel-mix optimization', blurb: 'A framework to measure campaign effectiveness and optimize spend across channels — grounded in causal inference and proper experimentation, not last-click guesswork.' },
...
(() => {
  ...
  PC.PROJECTS.forEach(p => {
    ...
    t.innerHTML = `<span class="pf-tag">${p.tag}</span><h3 class="pf-title">${p.title}</h3><p class="pf-blurb">${p.blurb}</p>`;
    card.appendChild(t);
